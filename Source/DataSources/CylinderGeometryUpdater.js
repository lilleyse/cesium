...
define([
    ...
    CylinderGeometryUpdater.prototype._onEntityPropertyChanged = function(entity, propertyName, newValue, oldValue) {
        ...
        this._castShadowsProperty = defaultValue(cyclinder.castShadows, defaultCastShadows);
        this._receiveShadowsProperty = defaultValue(cyclinder.receiveShadows, defaultReceiveShadows);
