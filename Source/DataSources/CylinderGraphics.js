...
define([
     ...
     * @param {Property} [options.castShadows=true] A boolean Property specifying whether the cylinder casts shadows from each light source.
     * @param {Property} [options.receiveShadows=true] A boolean Property specifying whether the cylinder receives shadows from shadow casters in the scene.
     *
     */
